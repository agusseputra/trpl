<?php namespace App\Http\Controllers;
	...
	class AdminBeritaController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Kategori Id","name"=>"kategori_id","join"=>"kategori,kategori_id"];
			...
			$this->form[] = ['label'=>'Kategori','name'=>'kategori_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'kategori,kategori'];
			$this->form[] = ['label'=>'Deskripsi','name'=>'description','type'=>'wysiwyg','validation'=>'required|string|min:5','width'=>'col-sm-10'];
